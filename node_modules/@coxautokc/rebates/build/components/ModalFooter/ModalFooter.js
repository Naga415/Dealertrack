...
function ModalFooter(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        _Col2.default,
        { sm: 8, md: 8, lg: 8, className: "leftbtn" },
        _react2.default.createElement(
          "div",
          {
          ...
          displayResetBtn && _react2.default.createElement("i", { className: "fa fa-refresh fa-2x", "aria-hidden": "true", onClick: resetData })
        )
      ),
      _react2.default.createElement(
        _Col2.default,
        { sm: 8, md: 8, lg: 8, className: "rightbtns" },
        _react2.default.createElement(
          _Button2.default,
          {
