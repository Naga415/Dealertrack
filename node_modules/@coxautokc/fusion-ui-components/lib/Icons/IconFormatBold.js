...
var IconFormatBold = function IconFormatBold(_ref) {
  ...
  return _react2.default.createElement(
    _SvgIcon2.default,
    Object.assign({ id: htmlId, className: '' + (className || '') + (isActive === true ? 'icon-format-bold-isActive ' : '') + 'svgicon icon-format-bold' }, other),
...
IconFormatBold.propTypes = {
  /** Additional classes to add to &lt;IconFormatBold/&gt; */
