  ...
  _createClass(LineGraph, [{
    ...
    value: function createChart(_self) {
      ...
      if (this.props.dataType !== 'date') {
        this.xScale = _d2.default.scale.linear().domain([_d2.default.min(this.props.data, function (d) {
          return d[_self.props.xDataKey];
        }), _d2.default.max(this.props.data, function (d) {
          return d[_self.props.xDataKey];
        })]).range([0, this.w]);
        ...
        _d2.default.extent(this.props.data, function (d) {
          return d[_self.props.xDataKey];
        }))
      ...
      _d2.default.min(this.props.data, function (d) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'svg',
          { className: "rd3r-chart rd3r-line-graph" + customClassName, id: this.props.htmlId, width: this.state.width, height: this.props.height },
          _react2.default.createElement(
            'g',
...
LineGraph.propTypes = {
  ...
  /** Override colors for lines e.g. <code>["#084b62", "yellow", "#ab264b"]</code>. The number of colors should match the number of data series. */
