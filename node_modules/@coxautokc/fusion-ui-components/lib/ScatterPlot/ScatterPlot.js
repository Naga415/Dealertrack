...
var _TrendLine = require('../internal/TrendLine');
...
var ScatterPlot = function (_React$Component) {
  ...
  function ScatterPlot(props) {
    ...
    _this.hideToolTip = function (e) {
      e.target.setAttribute('fill', _this.state.tooltip.originalColor);
      _this.setState({
        tooltip: {
          display: false,
          data: {
  ...
  _createClass(ScatterPlot, [{
    ...
    value: function render() {
      ...
      var dataPoints = this.dataNest.map(function (d, i) {
        var trendLine = [];

        if (_self.props.displayTrendLine) {
          trendLine.push(_react2.default.createElement(_TrendLine2.default, {
            key: i,
            data: d.values,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'svg',
          { className: "rd3r-chart rd3r-scatter-plot" + customClassName, id: this.props.htmlId, width: this.state.width, height: this.props.height },
          _react2.default.createElement(
            'g',
...
ScatterPlot.propTypes = {
  ...
  /** Override colors for data points e.g. <code>["#084b62", "yellow", "#ab264b"]</code>. The number of colors should match the number of data series. */
  ...
  /** Display trend line. */
  displayTrendLine: _propTypes2.default.bool,
  ...
  /** Trend line type of single trend for all data or multiple trend lines per data set. */
