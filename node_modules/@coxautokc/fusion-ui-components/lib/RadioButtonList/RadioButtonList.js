...
/**
 * RadioButtonList wraps the full Form group including
 * the Label, Control, and helpText.
 */
var RadioButtonList = function (_React$Component) {
  ...
  function RadioButtonList(props) {
    ...
    _this.onChange = function (event) {
      ...
      _this.setState({ error: _this.getError(value) }, function () {
        _this.props.onChange({ target: { name: name, value: value } }, !_this.getError(value));
      });
    };
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        options.map(function (_ref) {
          ...
          return _react2.default.createElement(
            _Radio2.default,
            Object.assign({ inline: inline,
              className: 'selectInput',
              title: title,
              key: htmlId + '-' + value,
              id: htmlId,
              checked: _this2.props.value === value,
...
RadioButtonList.propTypes = {
  ...
  /** An array of options as key value pairs: <code>[{value: '1', label: 'options 1'}]</code> */
