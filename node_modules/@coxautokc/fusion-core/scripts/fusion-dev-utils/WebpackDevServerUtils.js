...
function printInstructions(appName, urls, useYarn) {
  ...
  if (urls.lanUrlForTerminal) {
    ...
    /* DISABLED FOR FUSION - this feature is not working.*/
    // console.log(
    //   `  ${chalk.bold('On Your Network:')}  ${urls.lanUrlForTerminal}`
    // );
    /* ADDED FOR FUSION */
    console.log(
      `  ${chalk.bold('Mock API:')}         http://localhost:${chalk.bold('3002')}/`
    );
    /* END ADDED FOR FUSION */
  } else {
    console.log(`  ${urls.localUrlForTerminal}`);
  }

  /* DISABLED FOR FUSION - TURNING THIS OFF SINCE IT'S JUST NOISE */
  // console.log();
  ...
  return detect(defaultPort, host).then(
    port =>
      new Promise(resolve => {
        ...
        /* DISABLED FOR FUSION - We require the app to run on port 3000 and the mock API to run on 3002. */
        // if (isInteractive) {
        //
        //   //clearConsole();
